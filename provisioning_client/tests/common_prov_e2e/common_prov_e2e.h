...
static const char* const DPS_CONNECTION_STRING = "IOT_DPS_CONNECTION_STRING_C";
static const char* const DPS_GLOBAL_ENDPOINT = "IOT_DPS_GLOBAL_ENDPOINT_LINUX";
static const char* const DPS_ID_SCOPE = "IOT_DPS_ID_SCOPE_C";
static const char* const DPS_TPM_SIMULATOR_IP_ADDRESS = "IOT_DPS_TPM_SIMULATOR_IP_ADDRESS_WIN";
